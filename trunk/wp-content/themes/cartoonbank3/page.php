...
<div id="content">
   ...
   <div id="contentright">
      <div id="user_info"><span id="username"><a href='http://cartoonbank.ru/wp-login.php'>Пожалуйста, залогиньтесь.</a></span></div>
      <div id="shoppingcart"><img src="http://cartoonbank.ru/img/loading.gif" alt="loading"></div>
      <?php get_sidebar(); ?>
   </div>
	...
	*/
	...
	/*
	  ...
	  if (isset($_GET['page_id']) && $_GET['page_id']=='29'){
	  ?>
	<div id="topfooter" style="padding-top:10px;border-top:1px solid #C0C0C0; background: #FFFFFF url(<? echo (SITEURL.'img/w.png');?>) top center repeat-y;">
	  <h4>Популярные темы. Выбирайте или <a href="<? echo SITEURL;?>?page_id=927" style="color:#CC3300;border:1px solid silver;padding-left:6px;padding-right:6px;">введите своё ключевое слово</a>...</h4>
	  <?
	...
	<div style="text-align:right;background-color:white;border-bottom:1px solid #C0C0C0;">
	  <a href="<?echo SITEURL;?>?page_id=390">
		 <h4>...здесь ещё больше ключевых слов</h4>
	  </a>
	</div>
	<?
	  }
