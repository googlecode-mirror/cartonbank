...
$_bottomstriptext = "<div style=\'text-align:right;width:600px;float:right;\'><form onsubmit=\'submitform(this);return false;\' action=\'".get_option('siteurl')."/?page_id=29&amp;category=\' method=\'POST\'>Выбор лицензии: <input type=\'radio\' name=\'license\' value=\'l1_price\'>".$product['l1_price']."&nbsp;руб. <a target=\'_blank\'href=\'".get_option('siteurl')."/?page_id=238\'>ограниченная</a> <input type=\'radio\' name=\'license\' value=\'l2_price\'>".$product['l2_price']."&nbsp;руб. <a target=\'_blank\'href=\'".get_option('siteurl')."/?page_id=242\'>стандартная</a> <input type=\'radio\' name=\'license\' value=\'l3_price\'>".$product['l3_price']."&nbsp;руб. <a target=\'_blank\'href=\'".get_option('siteurl')."/?page_id=245\'>расширенная</a>&nbsp;&nbsp;&nbsp;&nbsp;<input type=\'hidden\' value=\'".$_number."\' name=\'prodid\'><input id=\'searchsubmit\' value=\'Купить\' type=\'submit\'></form></div>";
