...
define('TXT_WPSC_IMAGESIZEINFO', 'Внимание: Если оставить поле пустым, размер картинки не будет изменён.');
define('TXT_WPSC_RECEIVED', 'Заказ принят');
define('TXT_WPSC_ORDER_STATUS', 'Статус заказов');
define('TXT_WPSC_ORDER_SUMMARY', 'Всего заказов');
define('TXT_WPSC_LANGUAGE', 'Язык');
define('TXT_WPSC_ACCEPTED_PAYMENT', 'Принят платёж');
define('TXT_WPSC_JOB_DISPATCHED', 'Работа Отправление');
define('TXT_WPSC_PROCESSED', 'Закрыт заказ');
define('TXT_WPSC_ECOMMERCE', 'e-Commerce');
define('TXT_WPSC_OPTIONS', 'Параметры магазина');
define('TXT_WPSC_ADDPRODUCTS', 'Добавить продукт');
define('TXT_WPSC_SENDSMS', 'Отправка SMS');
define('TXT_WPSC_PRODUCTS', 'Продукты');
define('TXT_WPSC_ADDCATEGORY', 'Добавить категорию');
define('TXT_WPSC_CATEGORIES', 'Категория');
define('TXT_WPSC_BRANDS', 'Автор');
define('TXT_WPSC_VARIATIONS', 'Варьирование');
define('TXT_WPSC_PURCHASELOG', 'Лог заказов');
define('TXT_WPSC_ORDER_LOG', 'Заказов');
define('TXT_WPSC_OLDER_ORDERS', 'Старые заказы');
define('TXT_WPSC_ORDER', 'Заказ');
define('TXT_WPSC_TOTAL_THIS_MONTH', 'Всего денег сделано в этом месяце');
define('TXT_WPSC_MONTHLY_REPORT', 'Отчет за полгода');
define('TXT_WPSC_TOTAL_INCOME', 'Всего вошло');
define('TXT_WPSC_ACCEPTED_PAYMENTS', '(Принятие оплаты)'); //texr has changed slightly
define('TXT_WPSC_PAYMENTGATEWAYOPTIONS', 'Параметры доступа');
define('TXT_WPSC_HELPINSTALLATION', 'Помощь/Обновить');
define('TXT_WPSC_EXAMPLECATEGORY', 'Примерная категория');
define('TXT_WPSC_EXAMPLEDETAILS', 'Примерные детали');
define('TXT_WPSC_EXAMPLEBRAND', 'Примерный автор');
define('TXT_WPSC_PRODUCTIMAGEWIDTH', 'ширина картинки');
define('TXT_WPSC_PRODUCTIMAGEHEIGHT', 'Высота картинки');
define('TXT_WPSC_CATEGORYIMAGEWIDTH', 'ширина картинки категорий');
define('TXT_WPSC_CATEGORYIMAGEHEIGHT', 'Высота картинки категорий');
define('TXT_WPSC_PRODUCTLISTURL', 'расположение списка продуктов');
define('TXT_WPSC_SHOPPINGCARTURL', 'расположение списка корзина для заказов');
define('TXT_WPSC_CHECKOUTURL', 'расположение списка страница оплаты');
define('TXT_WPSC_TRANSACTURL', 'расположение списка соглашение страницы деталей');
define('TXT_WPSC_PAYMENTGATEWAY', 'The payment gateway to use');
define('TXT_WPSC_CARTLOCATION', 'Расположение корзины');
define('TXT_WPSC_SHOWCATEGORYBRANDS', 'Паказывать категории или бренд или обе');
define('TXT_WPSC_CURRENCYTYPE', 'тип валюты');
define('TXT_WPSC_CURRENCYSIGNLOCATION', 'Символ валюты');
define('TXT_WPSC_GSTRATE', 'the GST rate');
define('TXT_WPSC_MAXDOWNLOADS', 'Лимит закачки');
...
define('TXT_WPSC_DEFAULTBRAND', 'по умолчанию бренд');
define('TXT_WPSC_DEFAULTCATEGORY', 'по умолчанию категория');
define('TXT_WPSC_PAYPALBUSINESS', 'paypal работа');
define('TXT_WPSC_PAYPALURL', 'paypal url');
define('TXT_WPSC_SHOWPRODUCTRATINGS', 'Показать оценку картинки');
define('TXT_WPSC_PRODUCTSPAGE', 'Выбрать изображение');
define('TXT_WPSC_CHECKOUT', 'Оплата');
define('TXT_WPSC_ENTERDETAILS', 'Введите свои данные');
...
define('TXT_WPSC_PRODUCT_DISPLAY', 'Посмотреть изображение');

define('TXT_WPSC_PRODUCTSTOCK', 'Продуктов на складе');

define('TXT_WPSC_UNTICKBOX', 'Отметить для временного исключения картинки из магазина.');
define('TXT_WPSC_LIMITED_STOCK', 'Лимит продукта');

define('TXT_WPSC_CATEGORY', 'Раздел');
define('TXT_WPSC_BRAND', 'Автор');
define('TXT_WPSC_PRODUCT_VARS', 'Дополнительные опции');
define('TXT_WPSC_ADD_VAR', 'Добавить опции');
define('TXT_WPSC_EDIT_VAR', 'Изменить опции');
define('TXT_WPSC_SELECTAVARIATION', 'Выбрать опцию');
define('TXT_WPSC_NEW_VARIATION', 'Создать новую опцию');

define('TXT_WPSC_PRODUCTATT', 'прикрепление к продукту');
define('TXT_WPSC_DOWNLOADABLEPRODUCT', 'Картинка');
define('TXT_WPSC_FILETOBEPRODUCT', 'Это тот файл, ссылка на который будет отправлена заказчику.');
define('TXT_WPSC_RESIZEIMAGE', 'Изменить размер иконки');
define('TXT_WPSC_DONOTRESIZEIMAGE', 'не изменять размер иконки.');
define('TXT_WPSC_USEDEFAULTHEIGHTANDWIDTH', 'использовать стандартные настройки высоты и ширины');
define('TXT_WPSC_USE', 'use');
define('TXT_WPSC_PXHEIGHTBY', 'px высота');
define('TXT_WPSC_PXWIDTH', 'px ширина.');
define('TXT_WPSC_PREVIEW', 'показать изображение');
define('TXT_WPSC_UPLOADNEWIMAGE', 'Переписать изображение');
define('TXT_WPSC_DELETEIMAGE', 'Удалить изображение');
define('TXT_WPSC_EDIT', 'edit');
define('TXT_WPSC_DELETE', 'del');
define('TXT_WPSC_REMOVE', 'del');
define('TXT_WPSC_NAME', 'Имя');
define('TXT_WPSC_TYPE', 'Тип');
define('TXT_WPSC_MANDATORY', 'обязательно');
define('TXT_WPSC_DISPLAY_IN_LOG', 'Показать<br /> в логе');
define('TXT_WPSC_DESCRIPTION', 'описание');
define('TXT_WPSC_CATEGORY_PARENT', 'родитель категории');
define('TXT_WPSC_IMAGE', 'Фото');
define('TXT_WPSC_HEIGHT', 'ширина');
define('TXT_WPSC_WIDTH', 'высота');
define('TXT_WPSC_PLEASEENTERAVALID', 'Пожалуйста, введите правильно');
define('TXT_WPSC_PLEASEENTERAVALIDNAME', 'Пожалуйста, введите правильное имя');
define('TXT_WPSC_PLEASEENTERAVALIDSURNAME', 'Пожалуйста, введите правильную фамилию');
define('TXT_WPSC_PLEASEENTERAVALIDEMAILADDRESS', 'Пожалуйста, введите правильный E-mail');
define('TXT_WPSC_PLEASEENTERAVALIDADDRESS', 'Пожалуйста, введите правильный адрес');
define('TXT_WPSC_PLEASEENTERAVALIDPHONENUMBER', 'Пожалуйста введите правильный номер телефона');
define('TXT_WPSC_TERMSANDCONDITIONS', 'Вы не подтвердили принятие Соглашения');
...
define('TXT_WPSC_ADDNEWCATEGORY', 'Добавить категорию');
define('TXT_WPSC_SUBMIT', 'Принять');
define('TXT_WPSC_SELECTAVALIDCATEGORY', 'Пожалуйста выберите правильную категорию');
define('TXT_WPSC_PRODUCTNAME', 'Имя продукта');
define('TXT_WPSC_PRODUCTDESCRIPTION', 'Дополнительно о продукте');
define('TXT_WPSC_ADDNEWPRODUCT', 'Добавить продукт');
define('TXT_WPSC_PRODUCTQUANTITY', 'Количество продукта (Кол.)');
define('TXT_WPSC_PRODUCTIMAGE', 'Превьюшка');
define('TXT_WPSC_PRODUCTPRICE', 'Цена продукта');
define('TXT_WPSC_NOTAX', 'Нет налога');
...
define('TXT_WPSC_CONTACTDETAILS', 'Подтвердите информацию о себе:');
define('TXT_WPSC_CREDITCARDHANDY', 'После нажатия кнопки "Оплатить" в зависимости от формы оплаты могут понадобиться данные вашей кредитной карты.');
define('TXT_WPSC_ASTERISK', 'Поля, отмеченные звёздочкой обязательны для заполнения.');
...
define('TXT_WPSC_TERMS1', 'Я согласен с ');
define('TXT_WPSC_TERMS2', 'условиями соглашения');
...
define('TXT_WPSC_MAKEPURCHASE', 'Оплатить');
define('TXT_WPSC_BUYPRODUCTS', 'Сначала добавьте изображение в корзину.');
define('TXT_WPSC_BRANDHASBEENEDITED', 'Автора изменён.');
define('TXT_WPSC_SURETODELETEPRODUCT', 'Вы действительно хотите удалить изображение из базы?');
define('TXT_WPSC_ADDBRAND', 'Добавить Автора');
define('TXT_WPSC_DISPLAYBRANDS', 'Показать Автора');
define('TXT_WPSC_EDITBRAND', 'Изменить Автора');
define('TXT_WPSC_ADD', 'Добавить в базу данных');
define('TXT_WPSC_ADD_NEW_FORM', 'Добавить новую строку');
define('TXT_WPSC_SAVE_CHANGES', 'Сохранить изменение');

define('TXT_WPSC_CATEGORYHASBEENEDITED', 'Категория отредактирована.');
define('TXT_WPSC_DISPLAYCATEGORIES', 'показать категории');
define('TXT_WPSC_ADDCATEGORY', 'Добавить категорию');
define('TXT_WPSC_EDITCATEGORY', 'Редактировать категории');
define('TXT_WPSC_ALLCATEGORIES', 'Все категории');

define('TXT_WPSC_DISPLAYVARIATIONS', 'Показать опции');
define('TXT_WPSC_ADDVARIATION', 'Добавить набор опций');
define('TXT_WPSC_EDITVARIATION', 'Редактировать набор опций');
define('TXT_WPSC_VARIATIONHASBEENEDITED', 'Опции отредактированы.');
define('TXT_WPSC_VARIATION_VALUES', 'Значения опций');
...
define('TXT_WPSC_PRODUCTDETAILS', 'Описание картинки');
define('TXT_WPSC_SELECT_PRODUCT', 'Выбрать работу');
define('TXT_WPSC_ENTERPRODUCTDETAILSHERE', '(внимательно заполните поля)');
define('TXT_WPSC_ADDITIONALPRODUCTDESCRIPTION', 'Ключевые слова');
define('TXT_WPSC_ADDITEM', 'Add Item');
define('TXT_WPSC_CHOOSEACATEGORY', 'Выберите Категорию');
define('TXT_WPSC_CHOOSEABRAND', 'Выберите Автора');
...
define('TXT_WPSC_FINALTOTAL', 'Окончательная цена');
define('TXT_WPSC_CUSTOMERDETAILS', 'О заказчике');
...
define('TXT_WPSC_PLEASESELECTAPAYMENTGATEWAY', 'Выберите способ оплаты');
...
define('TXT_WPSC_DETAILS', 'Подробнее');
define('TXT_WPSC_MOREDETAILS', 'Ещё подробнее');
define('TXT_WPSC_ADDTOCART', 'В корзину');
...
define('TXT_WPSC_PRODUCT', 'Название');
define('TXT_WPSC_QUANTITY', 'Количество');
define('TXT_WPSC_QUANTITY_SHORT', 'Кол.'); //translation needed
define('TXT_WPSC_APPLY', 'Apply');
define('TXT_WPSC_MAKEPAYMENT', 'Подтвердить выбор');
define('TXT_WPSC_EMPTYSHOPPINGCART', 'Очистить корзину');
define('TXT_WPSC_TOTALPRICE', 'Стоимость');
define('TXT_WPSC_NOITEMSINTHESHOPPINGCART', 'В корзине ничего нет');
define('TXT_WPSC_EMAILMSG1', "Спасибо, ваш заказ принят. Вы можете скачать заказ используя ссылки ниже.\n\r\n\rВы заказали следующие картинки:\n\r\n\r");
define('TXT_WPSC_EMAILMSG2', ".\n\rБыли заказаны следующие картинки:\n\r\n\r");
define('TXT_WPSC_CLICKTODOWNLOAD', 'Кликните здесь, чтобы скачать');
...
define('TXT_WPSC_THETRANSACTIONWASSUCCESSFUL', 'Транзакция прошла успешно.');
define('TXT_WPSC_THETRANSACTIONWASNOTSUCCESSFUL', 'Транзакция не прошла.');
define('TXT_WPSC_GOBACKTOCHECKOUT', 'Вернутся к оплате ');
define('TXT_WPSC_SPECIALPRICE', 'Специальные цены');
...
define('TXT_WPSC_SHIPPING_DETAILS', 'Расходы на доставку'); 
define('TXT_WPSC_LOCAL_PNP', 'Местная доставка'); 
define('TXT_WPSC_INTERNATIONAL_PNP', 'Международная доставка');
...
define('TXT_WPSC_SHIPPING', 'Доставка почтой');
...
define('TXT_WPSC_PRODUCTIMAGES', 'Загрузите превьюшку, если хотите, чтобы она отличалась от оригинала. В противном случае оставьте поля незаполненными');
define('TXT_WPSC_PRODUCTDOWNLOAD', 'Файл для печати');
...
define('TXT_WPSC_PREVIEW_FILE', 'Скачать для просмотра');
define('TXT_WPSC_REPLACE_PRODUCT', 'Заменить файл картинки');

//ales
define('TXT_WPSC_SUBTOTAL', 'Итого');
define('TXT_WPSC_POSTAGE', 'Доставка');
define('TXT_WPSC_PLEASEENTERAVALIDCITY', 'Пожалуйста, введите город');
define('TXT_WPSC_PLEASESELECTCOUNTRY', 'Пожалуйста, выберите страну');
define('TXT_WPSC_DISPLAY_FRONT_PAGE', 'Показывать в Витрине');


define('TXT_WPSC_PICTURE_NAME', 'Название');
define('TXT_WPSC_TOTAL_ITEMS', 'Всего найдено картинок');
define('TXT_WPSC_NEXT_PAGE', 'Следующая страница');
define('TXT_WPSC_PREV_PAGE', 'Предыдущая страница');

define('TXT_WPSC_HELLO', 'Здравствуйте, ');
define('TXT_WPSC_NOTHING_FOUND', 'Извините, ничего не найдено.');

define('TXT_WPSC_PLEASEAGREETERMSANDCONDITIONS', 'Пожалуйста, ознакомьтесь с условиями соглашения и отметьте в квадратике ниже');
?>