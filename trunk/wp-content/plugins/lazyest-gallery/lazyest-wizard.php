...
$cfg = array(
	'wizardheadline'    => 'Wizard Headline',
	'wizardbyline'      => 'Wizard Byline',
...
$users = array(
	...
	get_settings('lg_wizard_user') => array(
		'password' => base64_decode(get_settings('lg_wizard_password')),
		'dirs' => $finaldirs
		),
...
<html>
	...
	<body style="background-color:#000;">
		<div style="text-align:center;color:white;padding-top:100px;">
				<?php _e("Hey! don't try to cheat!", $lg_text_domain); ?>
		</div>
	</body>
</html>
