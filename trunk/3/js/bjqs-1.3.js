    ...
    $.fn.bjqs = function(o) {
            ...
            $c_wrapper.on('click','a',function(e){
                ...
                if(!state.animating){
                    ...
                    if(direction === vars.fwd){
                        go(vars.fwd,false);
						var id=parseInt(($('li.active-marker').attr('id').split('_')[1])) + 1;
						var cuid = $('ul.bjqs li:nth-child('+id+')').attr('id');
						get_stars(cuid);
                    }

                    if(direction === vars.prev){
                        go(vars.prev,false);
						var id=$('li.active-marker').attr('id').split('_')[1];
						var cuid = $('ul.bjqs li:nth-child('+id+')').attr('id');
						get_stars(cuid);
                    }
        ...
        var conf_markers = function() {
            ...
            $.each($slides, function(key, slide){
				...
				//$('li.active-marker').attr('id').split('_')[1] - slide number
