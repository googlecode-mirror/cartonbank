...
if ($upd != 1)
{
	...
	{
		// fave exists
		$ret = "<img src='http://109.120.143.27/cb/img/thumbup.jpg' border='0' align=top title='удалить из списка любимых' style='cursor: pointer;'>";
	}
	else
	{
		// no faves
		$ret = "<img src='http://109.120.143.27/cb/img/thumbupp.jpg' border='0' align=top title='добавить в любимое' style='cursor: pointer;'>";
	}
}
else
{
