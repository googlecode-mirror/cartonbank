...
<td valign="top">
    ...
    <td>
		...
		<td width="33%" align="center" class="copyr">${msg:chat.window.poweredby} <a id="poweredByLink" href="http://cartoonbank.ru" title="Картунбанк" target="_blank">cartoonbank.ru</a></td>
