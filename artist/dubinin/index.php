...
<html>
 <head>
  ...
  <title> Список работ Валентина Дубинина </title>
	<style>
	.t{
 ...
 <body>
<h1>Список работ Валентина Дубинина. Карикатуры. </h1>
...
{$p=5000;}
	...
	$sql = "SELECT `id`,`name`,`description`,`additional_description` FROM `wp_product_list` where `active`=1 and `brand`= 30 order by id LIMIT ".($p-1000)." , 1000";
///pokazh($sql);
