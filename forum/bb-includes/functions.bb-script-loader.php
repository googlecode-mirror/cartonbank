...
function bb_just_in_time_script_localization() {
	wp_localize_script( 'topic', 'bbTopicJS', array(
		...
		'confirmPostDelete' => __("Вы уверены, что хотите стереть этот пост?"),
		'confirmPostUnDelete' => __("Вы уверены, что хотите восстановить этот пост?"),
		'favLinkYes' => __( 'favorites' ),
		'favLinkNo' => __( '?' ),
		'favYes' => __( 'This topic is one of your %favLinkYes% [%favDel%]' ),
		'favNo' => __( '%favAdd% (%favLinkNo%)' ),
		'favDel' => __( '&times;' ),
		'favAdd' => __( 'Добавить тему в избранное' )
	));
}
