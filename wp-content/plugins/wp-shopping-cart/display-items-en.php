...
<div class="wrap">
    <h2>Images collection and upload form</h2>
    ...
    <a href="#" class="button add-new-h2" onclick="var editpicid=document.getElementById('editpicid').value;filleditform(editpicid.replace(/(^\s+)|(\s+$)/g, ''));return false;">Select cartoon by unique number</a><br />
    ...
    <?php
        ...
        if(($offset >= $items_on_page) && ($items_count>0))
        {
            ...
            $output .= "<a href='admin.php?page=wp-shopping-cart/display-items.php&brand=".$_brand."&category=".$_category."&offset=".$offset_back."'><< Prev. page</a><br />";
        }
        if(($offset < $items_count - $items_on_page) && ($items_count>0))
        {
            // "Next page" link
            $offset_forw = $offset + $items_on_page;
            $output .= "<a href='admin.php?page=wp-shopping-cart/display-items.php&brand=".$_brand."&category=".$_category."&offset=".$offset_forw."'>Next page >></a>";
        }
        $output .= "</br></div>";
        ...
        if($items_count>0)
        {
            $diapazon = " (".$from_num."-".$to_num." of ".$items_count.")";
        }
        else{$diapazon = "<br />no images";}
        echo "Displaying $diapazon";
        echo $output; 
        echo "</td>\n\r";
        echo "</tr>\n\r";
...
*/
    ...
    ?>
    <div style='color:#006699'><b>Upload and edit form</b> <a href="#" onclick="return showaddform()" class="button add-new-h2" style='color:#000099;'>clear the form</a></div>
    <?
    ...
    <div id='additem'>
        <form  id='editproductform' method='POST' enctype='multipart/form-data'>
            <table class='additem'>
                ...
                <tr>
                    <td class='r'>
                        Tags,<br />separated by<br />commas:
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input id='visible' type="checkbox" name="visible" checked="checked"> <span style="color:#999;">uncheck to hide from collection</span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="lalt">
                        <input id='colored' type="checkbox" name="colored" checked="checked"> <span style="color:#999;">uncheck for b/w</span>
                    </td>
                </tr>
                <tr>
                    <td class='r'>
                ...
                <tr>
                    ...
                    <td class='lalt'>
                        <input name="category[]" value="4" type="radio"><label style="background-color:#80D6F7;padding:2px;">Cartoon+words</label><br><input name="category[]" value="5" type="radio"><label style="background-color:#F3C1A3;padding:2px;">Cartoon</label><br><input name="category[]" value="6" type="radio"><label>Artoon</label><br><input name="category[]" value="11" type="radio"><label style="background-color:#FFC4E1;padding:2px;">Unknown</label><br><input name="category[]" value="13" type="radio"><label>Collage</label><br><input name="category[]" value="14" type="radio"><label>Caricature</label><br><input name="category[]" value="15" type="radio"><label>Strip</label><br><input name="category[]" value="666" type="radio"><label style="background-color:#C9FCED;padding:2px;">Not for sale</label><br>                    
                    </td>
                </tr>
                <tr>
                    <td class='r'>
                    ...
                    <td>
                        <input id='temadnya' type="checkbox" name="temadnya"> <span style="color:#999;">Hot topic</span>
                    </td>
                </tr>
<?
if (isset($current_user->wp_capabilities['administrator']) && $current_user->wp_capabilities['administrator']==1){
...
?>
                <tr <? echo $stle; ?>>
                    ...
                    <td class='lalt'>
                        &nbsp;&nbsp;&nbsp;Ltd:&nbsp;<input id='license1' type="checkbox" name="license1" checked="checked">&nbsp;&nbsp;&nbsp;Snd:&nbsp;<input id='license2' type="checkbox" name="license2" checked="checked">&nbsp;&nbsp;&nbsp;Ext:&nbsp;<input id='license3' type="checkbox" name="license3" checked="checked"><br />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><br />
                        ...
                        <input type="button" name='sendit' style='padding:6px;background-color:#84DF88;' value='Add to collection' onclick="checkthefields();"/>
                    </td>
                </tr>
            </table>
        </form>
