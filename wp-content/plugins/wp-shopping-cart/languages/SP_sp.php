...
define('TXT_WPSC_IMAGESIZEINFO', utf8_encode('Nota: si estб en blanco, la imagen no serб dimensionada'));
...
define('TXT_WPSC_ADDPRODUCTS', utf8_encode('Aсadir productos'));
define('TXT_WPSC_SENDSMS', utf8_encode('Enviar SMS'));
define('TXT_WPSC_PRODUCTS', utf8_encode('Productos'));
define('TXT_WPSC_ADDCATEGORY', utf8_encode('Aсadir Categorнa'));
define('TXT_WPSC_CATEGORIES', utf8_encode('Categorнas'));
...
define('TXT_WPSC_EXAMPLECATEGORY', utf8_encode('Categorнa ejemplo'));
...
define('TXT_WPSC_CATEGORYIMAGEWIDTH', utf8_encode('Ancho imagen categorнa'));
define('TXT_WPSC_CATEGORYIMAGEHEIGHT', utf8_encode('Alto imagen categorнa'));
define('TXT_WPSC_PRODUCTLISTURL', utf8_encode('Posiciуn de la lista de productos'));
define('TXT_WPSC_SHOPPINGCARTURL', utf8_encode('Posiciуn del carrito de compra'));
define('TXT_WPSC_CHECKOUTURL', utf8_encode('Posiciуn de la pбgina de compra'));
define('TXT_WPSC_TRANSACTURL', utf8_encode('Posiciуn de la pбgina de detalle de transacciуn'));
define('TXT_WPSC_PAYMENTGATEWAY', utf8_encode('Pasarela de pago a usar'));
define('TXT_WPSC_CARTLOCATION', utf8_encode('Posiciуn de carrito'));
define('TXT_WPSC_SHOWCATEGORYBRANDS', utf8_encode('Mostrar categorнas o tipos o ambos'));
define('TXT_WPSC_CURRENCYTYPE', utf8_encode('Tipo de moneda'));
define('TXT_WPSC_CURRENCYSIGNLOCATION', utf8_encode('Posiciуn del sнmbolo de moneda'));
define('TXT_WPSC_GSTRATE', utf8_encode('GST'));
define('TXT_WPSC_MAXDOWNLOADS', utf8_encode('Lнmite de descarga'));
define('TXT_WPSC_DISPLAYPNP', utf8_encode('Mostrar u ocultar franqueo y empaquetado'));
define('TXT_WPSC_DISPLAYSPECIALS', utf8_encode('Mostrar u ocultar ofertas en la barra de menъ'));
define('TXT_WPSC_POSTAGEAND_PACKAGING', utf8_encode('Franqueo y empaquetado por defecto'));
define('TXT_WPSC_PURCHLOGEMAIL', utf8_encode('Direcciуn de correo donde se envнa el registro de compra'));
define('TXT_WPSC_RETURNEMAIL', utf8_encode('Direcciуn de correo desde donde se envнan los informes'));
...
define('TXT_WPSC_DEFAULTCATEGORY', utf8_encode('Categorнa por defecto'));
...
define('TXT_WPSC_PRODUCTSPAGE', utf8_encode('Pбgina de productos'));
define('TXT_WPSC_CHECKOUT', utf8_encode('Validar'));
define('TXT_WPSC_ENTERDETAILS', utf8_encode('Introduzca sus datos'));
define('TXT_WPSC_TRANSACTIONRESULTS', utf8_encode('Resultados de transacciуn'));
define('TXT_WPSC_SELECTACATEGORY', utf8_encode('Seleccione una categorнa'));
define('TXT_WPSC_SELECTABRAND', utf8_encode('Seleccione un tipo'));
define('TXT_WPSC_PRODUCTNAME', utf8_encode('Nombre de producto'));
define('TXT_WPSC_PRODUCTDESCRIPTION', utf8_encode('Descripciуn de producto'));
define('TXT_WPSC_ADDITIONALDESCRIPTION', utf8_encode('Descripciуn adicional'));
define('TXT_WPSC_PRICE', utf8_encode('Precio'));
define('TXT_WPSC_TAXALREADYINCLUDED', utf8_encode('No incluye tasas (las tasas son introducidas en la configuraciуn de la tienda)')); // this text has changed and needs updating
...
define('TXT_WPSC_UNTICKBOX', utf8_encode('Existe un nъmero limitado de este artнculo en stock. Si el sotck se agota, este producto no estarб disponible en la tienda a no ser que usted quite esta opciуn o aсada mбs stock.'));
define('TXT_WPSC_LIMITED_STOCK', utf8_encode('Stock limitado'));

define('TXT_WPSC_CATEGORY', utf8_encode('Categorнa'));
define('TXT_WPSC_BRAND', utf8_encode('Tipo'));
define('TXT_WPSC_PRODUCT_VARS', utf8_encode('Opciones de producto'));
define('TXT_WPSC_ADD_VAR', utf8_encode('Aсadir opciуn'));
define('TXT_WPSC_EDIT_VAR', utf8_encode('Editar opciуn'));
define('TXT_WPSC_SELECTAVARIATION', utf8_encode('Seleccione una opciуn'));
define('TXT_WPSC_NEW_VARIATION', utf8_encode('Crear nueva opciуn'));
...
define('TXT_WPSC_FILETOBEPRODUCT', utf8_encode('Nota: Si estб completado, el archivo subido serб el producto para ser comprado.'));
...
define('TXT_WPSC_DESCRIPTION', utf8_encode('Descripciуn'));
define('TXT_WPSC_CATEGORY_PARENT', utf8_encode('Categorнa padre'));
...
define('TXT_WPSC_PLEASEENTERAVALIDNAME', utf8_encode('Por favor introduzca un nombre vбlido'));
define('TXT_WPSC_PLEASEENTERAVALIDSURNAME', utf8_encode('Por favor introduzca un apellido vбlido'));
define('TXT_WPSC_PLEASEENTERAVALIDEMAILADDRESS', utf8_encode('Por favor introduzca una direcciуn de correo vбlida'));
define('TXT_WPSC_PLEASEENTERAVALIDADDRESS', utf8_encode('Por favor introduzca una direcciуn vбlida'));
define('TXT_WPSC_PLEASEENTERAVALIDPHONENUMBER', utf8_encode('Por favor introduzca un nъmero de telйfono vбlido'));
define('TXT_WPSC_TERMSANDCONDITIONS', utf8_encode('Usted no estб de acuerdo con las condiciones'));
...
define('TXT_WPSC_NUMBEROFITEMS', utf8_encode('Nъmero de artнculos'));
define('TXT_WPSC_NOMOREAVAILABLE', utf8_encode('Este producto estб fuera de stock'));
...
define('TXT_WPSC_YOURSHOPPINGCARTISEMPTY', utf8_encode('Su carrito de compra estб vacнo'));
define('TXT_WPSC_VISITTHESHOP', utf8_encode('Visitar tienda'));
define('TXT_WPSC_PAGES', utf8_encode('Pбginas'));
define('TXT_WPSC_OUTOF', utf8_encode('Mбs de'));
define('TXT_WPSC_VOTES', utf8_encode('votos.'));
define('TXT_WPSC_CLICKSTARSTORATE', utf8_encode('Aсada estrellas para calificar'));
define('TXT_WPSC_AVERAGERATINGOF', utf8_encode('Grado medio de'));
define('TXT_WPSC_YOURVOTE', utf8_encode('Su votaciуn'));
define('TXT_WPSC_AVERAGEVOTE', utf8_encode('Media de votos'));
define('TXT_WPSC_YOUHAVEVOTED', utf8_encode('Usted ha votado'));
define('TXT_WPSC_NOVOTES', utf8_encode('Ningъn voto'));
...
define('TXT_WPSC_ITEMHASBEENADDED', utf8_encode('El artнculo se ha aсadido'));
define('TXT_WPSC_ITEMHASNOTBEENADDED', utf8_encode('El artнculo no se ha aсadido'));
define('TXT_WPSC_ADDNEWCATEGORY', utf8_encode('Aсadir nueva categorнa'));
define('TXT_WPSC_SUBMIT', utf8_encode('Enviar'));
define('TXT_WPSC_SELECTAVALIDCATEGORY', utf8_encode('Por favor seleccione una categorнa vбlida'));
define('TXT_WPSC_PRODUCTNAME', utf8_encode('Nombre del producto'));
define('TXT_WPSC_PRODUCTDESCRIPTION', utf8_encode('Descripciуn del producto'));
define('TXT_WPSC_ADDNEWPRODUCT', utf8_encode('Aсadir producto'));
...
define('TXT_WPSC_ABOUTCONTENT', utf8_encode('Bienvenido al panel e-commerce. <br /><br /><strong>Nota:</strong> en algunas configuraciones, el carrito de compra puede estar vacнo en cada carga de pбgina, si esto sucede, tendrб que aсadir esta lнnea:<br /><br />session_start();<br /><br />a index.php en el directorio base de wordpress.<br />'));
define('TXT_WPSC_CONTACTDETAILS', utf8_encode('Por favor introduzca sus datos de contacto:'));
define('TXT_WPSC_CREDITCARDHANDY', utf8_encode('Nota, una vez que presione enviar, necesitarб tener a mano su tarjeta de crйdito.'));
...
define('TXT_WPSC_ADDRESS', utf8_encode('Direcciуn'));
define('TXT_WPSC_ADDRESS1', utf8_encode('Direcciуn 1'));
define('TXT_WPSC_ADDRESS2', utf8_encode('Direcciуn 2'));
define('TXT_WPSC_CITY', utf8_encode('Ciudad'));
define('TXT_WPSC_COUNTRY', utf8_encode('Paнs'));
define('TXT_WPSC_PHONE', utf8_encode('Telйfono'));
...
define('TXT_WPSC_TEXTAREA', utf8_encode('Бrea de texto'));
define('TXT_WPSC_HEADING', utf8_encode('Tнtulo'));

define('TXT_WPSC_MAKEPURCHASE', utf8_encode('Hacer compra'));
define('TXT_WPSC_BUYPRODUCTS', utf8_encode('Por favor compre algъn producto antes de utilizar esta pбgina'));
define('TXT_WPSC_BRANDHASBEENEDITED', utf8_encode('El tipo ha sido modificado.'));
define('TXT_WPSC_SURETODELETEPRODUCT', utf8_encode('їEstб seguro de eliminar este producto?'));
define('TXT_WPSC_ADDBRAND', utf8_encode('Aсadir tipo'));
define('TXT_WPSC_DISPLAYBRANDS', utf8_encode('Mostrar tipos'));
define('TXT_WPSC_EDITBRAND', utf8_encode('Editar tipo'));
define('TXT_WPSC_ADD', utf8_encode('Aсadir'));
define('TXT_WPSC_ADD_NEW_FORM', utf8_encode('Aсadir nuevo campo en el formulario'));
define('TXT_WPSC_SAVE_CHANGES', utf8_encode('Guardar cambios'));

define('TXT_WPSC_CATEGORYHASBEENEDITED', utf8_encode('La categorнa ha sido modificada'));
define('TXT_WPSC_DISPLAYCATEGORIES', utf8_encode('Mostrar categorнas'));
define('TXT_WPSC_ADDCATEGORY', utf8_encode('Aсadir categorнa'));
define('TXT_WPSC_EDITCATEGORY', utf8_encode('Editar categorнa'));
define('TXT_WPSC_ALLCATEGORIES', utf8_encode('Todas las categorнas'));

define('TXT_WPSC_DISPLAYVARIATIONS', utf8_encode('Mostrar opciones'));
define('TXT_WPSC_ADDVARIATION', utf8_encode('Aсadir opciуn'));
define('TXT_WPSC_EDITVARIATION', utf8_encode('Editar opciуn'));
define('TXT_WPSC_VARIATIONHASBEENEDITED', utf8_encode('La opciуn ha sido modificada'));
define('TXT_WPSC_VARIATION_VALUES', utf8_encode('Valores de opciуn'));
...
define('TXT_WPSC_ADDPRODUCT', utf8_encode('Aсadir producto'));
define('TXT_WPSC_DISPLAYPRODUCTS', utf8_encode('Mostrar productos'));
define('TXT_WPSC_PLEASESELECTACATEGORY', utf8_encode('Por favor seleccione una categorнa'));
define('TXT_WPSC_STOCK', utf8_encode('Stock'));
define('TXT_WPSC_PNP', utf8_encode('PnP'));
define('TXT_WPSC_EDITITEM', utf8_encode('Editar artнculo'));
...
define('TXT_WPSC_ENTERPRODUCTDETAILSHERE', utf8_encode('(Introduzca su detalle del producto aquн)'));
define('TXT_WPSC_ADDITIONALPRODUCTDESCRIPTION', utf8_encode('Descripciуn del producto adicional'));
define('TXT_WPSC_ADDITEM', utf8_encode('Aсadir artнculo'));
define('TXT_WPSC_CHOOSEACATEGORY', utf8_encode('Elija una categorнa'));
...
define('TXT_WPSC_TRANSACTIONSTATUS', utf8_encode('Estado de la transacciуn'));
...
define('TXT_WPSC_FAILED', utf8_encode('Errуneo'));
...
define('TXT_WPSC_USERSCARTWASEMPTY', utf8_encode('Este carrito esta vacнo'));
...
define('TXT_WPSC_PAYMENTGATEWAYNOTE', utf8_encode('<strong>Nota:</strong> Esta versiуn del plugin e-Commerce sуlo te permite conectar con PayPal.<br /><br />Si estб buscando una pasarela profesional que no sea PayPal entonces tenemos la<a href="http://www.instinct.co.nz/blogshop">versiуn e-Commerce oro </a> disponible con pasarelas como authorize.net,  DPS (www.dps.co.nz), y paystation (www.paystation.co.nz).'));
...
define('TXT_WPSC_TRANSACTIONDETAILSURL', utf8_encode('URL de detalles de la transacciуn'));
define('TXT_WPSC_PRESENTATIONSETTINGS', utf8_encode('Opciones de presentaciуn'));
define('TXT_WPSC_CARTLOCATION', utf8_encode('Posiciуn del carrito'));
define('TXT_WPSC_SIDEBAR', utf8_encode('Barra de menъ'));
define('TXT_WPSC_PAGE', utf8_encode('Pбgina'));
...
define('TXT_WPSC_SHOWCATEGORIESBRANDS', utf8_encode('Mostrar categorнas/Tipos'));
define('TXT_WPSC_BOTH', utf8_encode('Ambos'));
define('TXT_WPSC_PRODUCTTHUMBNAILSIZE', utf8_encode('Tamaсo por defecto del thumbnail producto'));
define('TXT_WPSC_CATEGORYTHUMBNAILSIZE', utf8_encode('Tamaсo por defecto del thumbnail categorнa'));
define('TXT_WPSC_SHOWPOSTAGEANDPACKAGING', utf8_encode('Mostrar gastos de envнo'));
...
define('TXT_WPSC_CURRENCYTYPE', utf8_encode('Tipo de moneda'));
define('TXT_WPSC_CURRENCYSIGNLOCATION', utf8_encode('Sнmbolo de moneda del paнs'));
define('TXT_WPSC_DEFAULTPOSTAGEPACKAGING', utf8_encode('Franqueo y embalaje por defecto'));
define('TXT_WPSC_ADMINISTRATIONSETTINGS', utf8_encode('Opciones de administraciуn'));
define('TXT_WPSC_MAXDOWNLOADSPERFILE', utf8_encode('Descargas mбximas por fichero'));
...
define('TXT_WPSC_CATEGORYNOCAP', utf8_encode('categorнa'));
define('TXT_WPSC_UDPATING', utf8_encode('Actualizando'));
define('TXT_WPSC_MOREDETAILS', utf8_encode('Mбs detalles'));
define('TXT_WPSC_ADDTOCART', utf8_encode('Aсadir al carrito'));
...
define('TXT_WPSC_RATETHISITEM', utf8_encode('Tarifica este artнculo'));
define('TXT_WPSC_PRODUCTSOLDOUT', utf8_encode('Este producto es el mбs vendido.'));
define('TXT_WPSC_NOITEMSINTHIS', utf8_encode('No hay ningъn artнculo en esta'));
define('TXT_WPSC_CATEGORYORBRAND', utf8_encode('Categorнa o tipo'));
...
define('TXT_WPSC_NOITEMSINTHESHOPPINGCART', utf8_encode('No hay ningъn artнculo en el carrito'));
define('TXT_WPSC_EMAILMSG1', "Gracias, el pedido ha sido aceptado, serб procesado y enviado lo mбs pronto posible, los elementos pueden ser descargados usando los enlaces.\n\r\n\rTodos los precios incluyen tasas y gastos de envнo.\n\r\n\rDetalle de tu pedido:\n\r\n\r");
define('TXT_WPSC_EMAILMSG2', ".\n\rEstos artнculos fueron pedidos:\n\r\n\r");
define('TXT_WPSC_CLICKTODOWNLOAD', utf8_encode('Pinche aquн para descargar'));
define('TXT_WPSC_DOWNLOAD', utf8_encode('Descargar'));
define('TXT_WPSC_YOURTRANSACTIONID', utf8_encode('Nъmero de tu pedido'));
...
define('TXT_WPSC_THETRANSACTIONWASSUCCESSFUL', utf8_encode('Transacciуn correcta'));
define('TXT_WPSC_THETRANSACTIONWASNOTSUCCESSFUL', utf8_encode('Hubo un error en la transacciуn'));
...
define('TXT_WPSC_INSTRUCTIONS', utf8_encode('
  Para completar la instalaciуn usted tiene que crear los productos, el carrito de compra, las pбginas de la comprobaciуn y el resultado de transacciуn, y luego ocultar la pбgina del carrito, de la comprobaciуn y de resultado de la transacciуn, de modo que  no aparezcan en la lista de pбginas.
  <ul class=\'installation\'>
  <li>Subir el contenido del archivo zip dentro del directorio wp-content/plugins</li>
  <li>Activar el plugin desde la pбgina de plugins de wordpress</li>
  ...
  <li>Crear las categorнas y productos</li>
  </ul>
  Esto es todo.</p>
  <h2>Donaciones</h2>
  <p>Las donaciones no son obligadas.<br /><br />
  Hemos terminado el desarrollo en un tiempo considerable, a pesar de todo hay que apoyar la eliminaciуn de fallos de WP-E-commerce. Por lo tanto, si le gusta lo que usted ve, y quiere ver mбs de ello, puede ayudar a financiar futuras versiones es dejando caer un dуlar o dos en el depуsito de donaciones...</p>
  ...
  <h2>Personalizaciуn</h2>
  <p><strong>Tasas y gastos de envнo</strong><br />Se pueden poner por defecto en la pбgina de Opciones.</p>
  <p><strong>Email de Logs de compra</strong><br />Direcciуn para el envнo de notificaciones de las compras.</p>
  <p><strong>Pбginas ocultas</strong><br />
  Se debe buscar antes el ID de las pбginas ocultas del carrito de compra y el resultado de las transacciones para evitar que sean mostradas.<br />
  ...
  <br />Editar la lнnea, por ejemplo asн:<br />
  <br />"&lt;?php wp_list_pages(\'title_li=&lt;h2&gt;Pages&lt;h2&gt;&amp;exclude=3,4,5\')); ?&gt;"<br />
  <br />Las pбginas son excluнdas mediante su ID.</p>
  ...
  Si su servidor no tiene las funciones de imagen PHP instaladas, usted no serб capaz de redimensionar las imбgenes una vez subidas.</p>
  <p><strong>Permalinks</strong><br />
  Lo hacemos lo mejor que podemos.
  No he sido capaz de encontrar un modo realmente bueno de pasar las variables requeridas de la pбgina A la pбgina con permalinks que usan el modo reescritura (mod_rewrite), si usted se inclina en el empleo mod_rewrite,no puede trabajar con permalinks activado.</p>
  <p><strong>Javascript y Ajax </strong><br />
  E-commerce usa Ajax, el carrito de la compra no parece que utiliza Javascript, aunque detrбs sн,pero las pбginas de administraciуn (especнficamente las de Productos y Categorнas) no lo usan. Para usar la secciуn de Administraciуn usted tendrб que usar un navegador razonablemente moderno y tener Javascript activado. (Internet Explorer 6 o mejor, Firefox 1.0).</p>
...
define('TXT_WPSC_SHIPPINGSETTINGS', utf8_encode('Opciones de envнo'));
define('TXT_WPSC_BASE_LOCAL', utf8_encode('Localidad base de envнo'));
define('TXT_WPSC_BASE_INTERNATIONAL', utf8_encode('Envнos internacionales'));
define('TXT_WPSC_BASE_COUNTRY', utf8_encode('Paнs base de envнo'));

define('TXT_WPSC_SHIPPING_DETAILS', utf8_encode('Costes adicionales de envнo')); // this needs updating
define('TXT_WPSC_LOCAL_PNP', utf8_encode('Coste de envнo local')); // this needs updating
define('TXT_WPSC_INTERNATIONAL_PNP', utf8_encode('Coste de envнo internacional')); // this needs updating
define('TXT_WPSC_SHIPPING_NOTE', utf8_encode('Nota: cobrado sуlo una vez por producto independientemente de la cantidad pedida.'));
define('TXT_WPSC_COUNTRY_FORM_FIELD', utf8_encode('Campo de formulario para el paнs'));
define('TXT_WPSC_COUNTRY_FORM_FIELD_EXPLANATION', utf8_encode('(seleccionar cual es el campo del formulario para especificar el paнs)'));

define('TXT_WPSC_SHIPPING', utf8_encode('Envнo'));
define('TXT_WPSC_EMAIL_FORM_FIELD', utf8_encode('Campo de formulario para el email'));
define('TXT_WPSC_EMAIL_FORM_FIELD_EXPLANATION', utf8_encode('(seleccionar cual es el campo del formulario para especificar la direcciуn de correo)'));


define('TXT_WPSC_PRODUCTIMAGES', utf8_encode('Imбgenes de productos'));
define('TXT_WPSC_PRODUCTDOWNLOAD', utf8_encode('Descargar producto'));
define('TXT_WPSC_SHOWTHUMBNAILS', utf8_encode('Ver Thumbnails'));
define('TXT_WPSC_ADD_ADDITIONAL_IMAGE', utf8_encode('Aсadir imagen adicional'));
define('TXT_WPSC_DELETE_IMAGE', utf8_encode('Borrar imagen'));
define('TXT_WPSC_EXT_OPTIONS', utf8_encode('Opciones de carrito ext'));
define('TXT_WPSC_ACTIVATE_SETTINGS', utf8_encode('Opciones de activaciуn'));
define('TXT_WPSC_ACTIVATION_KEY', utf8_encode('KEY de activaciуn'));
define('TXT_WPSC_THANKSACTIVATED', utf8_encode('Gracias, el carrito de compra versiуn oro ha sido activado.'));
...
define('TXT_WPSC_SHIPPING_COUNTRY', utf8_encode('Elija su paнs de envнo:'));
define('TXT_WPSC_CONFIRM_TOTALS', utf8_encode('Verifique sus totales antes de realizar el pedido:'));
define('TXT_WPSC_CHECKOUT_FORM_FIELDS_DESCRIPTION', utf8_encode('Aquн usted puede personalizar las pasarelas de pago para que se muestren en su pбgina de compra. La pбgina de compra es donde usted recoge la informaciуn de usuario necesaria que se guardarб en sus Logs de compra p. ej. la direcciуn de compradores, y el nombre...'));
define('TXT_WPSC_PAYMENT_OPTIONS', utf8_encode('Opciones de pago'));
define('TXT_WPSC_PAYMENT_DESCRIPTION', utf8_encode('Escoja las opciones de pago que usted quiere en la pбgina de compra. Por defecto los clientes sуlo pueden pagar los artнculos con tarjeta de crйdito, sin embargo usted puede darles la opciуn Cheque/Transferencia. En el caso de que usted quisiera esta opciуn, deberнa seleccionar la tarjeta de crйdito mбs la opciуn de Cheque/Transferencia.'));

define('TXT_WPSC_DEFAULT_GATEWAY_ONLY', utf8_encode(' solo'));
define('TXT_WPSC_PLUS_MANUAL_PAYMENT', utf8_encode(' opciуn plus de pago Cheque/Transferencia'));
define('TXT_WPSC_PAYMENT_METHOD', utf8_encode('Mйtodo de pago'));
define('TXT_WPSC_PAY_USING', utf8_encode('Pago usado'));
define('TXT_WPSC_PAY_MANUALLY', utf8_encode('Pago por Cheque/Transferencia'));
define('TXT_WPSC_CREDIT_CARD', utf8_encode('Tarjeta de crйdito'));
define('TXT_WPSC_ADJUSTABLE_QUANTITY', utf8_encode('Mostrar cantidades en modo lista'));
define('TXT_WPSC_RSS_FEED_HEADER', utf8_encode('Suscrнbase a sus pedidos'));
define('TXT_WPSC_RSS_FEED_LINK', utf8_encode('Subscrнbase a un RSS'));
...
define('TXT_WPSC_PLUGIN_NEWS', utf8_encode('<a href="http://www.instinct.co.nz/wp-campaign-monitor/100" target="_blank">WP Monitor de campaсa</a> es un email de promociones para los usuarios de WP. 
 
La ъltima versiуn integra el boletнn de noticias, con el que usted serб capaz de enviar a los compradores los boletines de noticias a su email y mucho mбs.'));
...
define('TXT_WPSC_DELIVERY_ADDRESS', utf8_encode('Direcciуn de entrega'));
define('TXT_WPSC_DELIVERY_CITY', utf8_encode('Ciudad'));
define('TXT_WPSC_DELIVERY_COUNTRY', utf8_encode('Paнs'));
define('TXT_WPSC_MP3_SETTINGS', utf8_encode('Configuraciуn MP3'));
define('TXT_WPSC_MP3_SETTINGS_DESCRIPTION', utf8_encode('Para crear MP3 de 30 segundos, este plugin necesita <a href=\'http://sox.sourceforge.net/\'>SoX</a> introduzca la ruta al SoX aquн.'));
...
define('TXT_WPSC_TOTALSHIPPING', utf8_encode('Gastos de envнo totales'));
define('TXT_WPSC_DISPLAY_FRONT_PAGE', utf8_encode('Mostrar en pбgina principal'));
define('TXT_WPSC_SEARCH_FOR', utf8_encode('Buscar por'));
define('TXT_WPSC_YOUR_SEARCH_FOR', utf8_encode('Tu bъsqueda para'));
