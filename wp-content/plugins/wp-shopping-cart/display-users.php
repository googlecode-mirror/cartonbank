<?php
$sql = "SELECT id, user_login, user_nicename, user_registered, display_name, user_email, user_url, wallet, discount, contract FROM `wp_users` ORDER BY user_registered DESC LIMIT 300";
