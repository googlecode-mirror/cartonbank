...
$csl4 = "";
 switch($currency_sign_location)
   ...
   break;
      ...
      ?>
      <input type='radio' value='1' name='currency_sign_location' id='csl1' <?php echo $csl1; ?> /> <span for='csl1'>100<span id=cslchar1>$</span></label> &nbsp;
      <input type='radio' value='2' name='currency_sign_location' id='csl2' <?php echo $csl2; ?> /> <label for='csl2'>100 <span id=cslchar2>$</span></label> &nbsp;
      <input type='radio' value='3' name='currency_sign_location' id='csl3' <?php echo $csl3; ?> /> <label for='csl3'><span id=cslchar3>$</span>100</label> &nbsp;
      <input type='radio' value='4' name='currency_sign_location' id='csl4' <?php echo $csl4; ?> /> <label for='csl4'><span id=cslchar4>$</span> 100</label>
      </td>
    </tr>
    <?php
    /*
