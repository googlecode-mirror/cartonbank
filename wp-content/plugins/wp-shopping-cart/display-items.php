...
$_name = $wpdb->escape(removeCrLf(htmlspecialchars(stripslashes($_POST['name']))));
$_description = $wpdb->escape(removeCrLf(htmlspecialchars(stripslashes($_POST['description']))));
$_additional_description = $wpdb->escape(removeCrLf(htmlspecialchars(stripslashes($_POST['additional_description']))));



  $insertsql = "INSERT INTO `wp_product_list` ( `id`, `name`, `description`, `additional_description`, `file` , `image` , `category`, `brand`, `display_frontpage`, `visible`, `approved`, `color`, `not_for_sale`, `l1_price`, `l2_price`, `l3_price`) VALUES ('', '".$_name."', '".$_description."', '".$_additional_description."','".$file."', '".$image."', '".$category_id."', '".$_brand."', '$display_frontpage', '$visible', NULL, '$colored', '$not_for_sale', $l1_price, $l2_price, $l3_price);";
...
if (isset($_POST['brand']) && is_numeric($_POST['brand']))
	  ...
	  {
		$updatesql = "UPDATE `wp_product_list` SET `name` = '".$wpdb->escape(removeCrLf(htmlspecialchars($_POST['title'])))."', `description` = '".$_description."', `additional_description` = '".$_additional_description."', `category` = '".$wpdb->escape($_POST['category'][0])."', `brand` = '".$_brand."', `display_frontpage`='$display_frontpage', `visible`='$visible',`color`='$colored', `not_for_sale`='$not_for_sale', `l1_price`='$l1_price', `l2_price`='$l2_price', `l3_price`='$l3_price'  WHERE `id`='".$_POST['prodid']."' LIMIT 1";
	  }
	  else
	  {
