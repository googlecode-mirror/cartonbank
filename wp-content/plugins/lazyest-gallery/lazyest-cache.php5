...
function createCache5($thatdir, $file, $thumb) {
	global $gallery_root;
...
function create_cropped_file5($chwidth, $chheight, $thatdir, $ifolder, $file, $resample_quality) {
	global $gallery_root;
...
function create_resized_file5($chwidth, $chheight, $thatdir, $ifolder, $file, $thumb, $resample_quality) {
	global $gallery_root;
